            ...
            <div class ={a.text1}>
                <div class={a.text1_1}>
                    ...
                    <div class={a.krug_message}>
                        {/* <svg class={a.img_krug6} xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
                        <circle cx="36" cy="36" r="36" fill="#514A7E"/>
                        </svg> */}
                        {/* <img class={a.img_krug7} src="./img/clarity_chat-bubble-line.svg"/>
                        <svg class={a.img_krug7} xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
