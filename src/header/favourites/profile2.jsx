...
<div>  
    <div class={a.fav}>
        ...
        <img class={a.img1} src='./img/mas_img/clarity_trash-line.svg' />

        <img class={a.img1} src='./img/mas_img/clarity_shopping-bag-line.svg' />
        
        <div>
            <button class={a.btn_podrobnee}>Подробнее  
            <svg class={a.img_strelka} width="26" height="4" viewBox="0 0 26 4" fill="none" xmlns="http://www.w3.org/2000/svg">
